...
namespace IcSoftShopProduct.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public ExternalLoginModel(
            ...
            IUserStore<ShopUser> userStore, // Changed to ShopUser
            ILogger<ExternalLoginModel> logger,
            IEmailSender emailSender)
        {
            _signInManager = signInManager;
            _userManager = userManager;
            _userStore = userStore; // Changed to ShopUser
            _emailStore = GetEmailStore(); // Changed to ShopUser
            _logger = logger;
        ...
        private ShopUser CreateUser() // Changed to ShopUser
        {
            try
            {
                return Activator.CreateInstance<ShopUser>(); // Changed to ShopUser
            }
            catch
            {
        ...
        private IUserEmailStore<ShopUser> GetEmailStore() // Changed to ShopUser
        {
